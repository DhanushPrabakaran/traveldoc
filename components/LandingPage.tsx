...
const LandingPage = () => {
  return (
    <div className=" w-full h-screen  text-white bg-transprant bg-blend-overlay flex flex-col items-center justify-center align-middle  ">
      ...
      <div className="bg-gray-950 w-full max-w-xl flex py-2 rounded-xl flex-wrap justify-center items-center align-middle border border-gray-800 my-4">
        <div className=" flex flex-row justify-center items-center align-middle flex-grow">
